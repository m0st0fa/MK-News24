const handleCatageroy = async () =>{
    ...
    const tabContainer = document.getElementById('tabble-container')
    data.data.news_category.slice(0,3).forEach(category => {
        const div = document.createElement('div')
        div.innerHTML = `<a onclick="handleLoadNews('${category.category_id}')" class="tab">${category.category_name}</a>`;
        ...
        <div class="card-body">
          ...
          <div class="card-footer flex justify-between mt-8">
            <div class="flex">
              ...
              <div>
                <h6>${news.author.name.slice(0,7)}</h6>
